                ...
                <section class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3>Edit Supplier
                                <a class="btn btn-success float-right btn-sm" href="{{ route('supplieres.view') }}"><i class="fa fa-list"></i> Supplier List</a>
                            </h3>
                        </div><!-- /.card-header -->
                        <div class="card-body">
                            <form method="post" action="{{ route('supplieres.update', $editData->id) }}" id="myForm">
                                @csrf
